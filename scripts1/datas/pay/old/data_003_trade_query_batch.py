...
class Trade_query_batch_135_data():
    cases = [
        {
            "title":"000-查询成功",
            "expection":"",
        ...
        },
        {
            ...
            "expection":"",
            "case":{"channel":channel,"method":"elm.pmt.trade.query.batch","charset":"UTF-8","reqDateTime":time.strftime("%Y-%m-%d %H:%M:%S"),"version":"1.0","notifyUrl":"","authToken":"flajslkfjsalkfjlkdsajf","nonceStr":"fdslkjflkdsjflksjf","key":"fjsdalkfjlsaj","signType":"RSA","signStr":"wrwrw","md5Str":"","bizCnt":{"outBatchNo":"","startDate":"20201124","endDate":"20201125","outset":"0","offset":"2","rstSts":"","txType":""}}
        },
        {
            "title":"003-查询指定outBatchNo，查询成功",
            "expection":"",
            "case":{"channel":channel,"method":"elm.pmt.trade.query.batch","charset":"UTF-8","reqDateTime":time.strftime("%Y-%m-%d %H:%M:%S"),"version":"1.0","notifyUrl":"","authToken":"flajslkfjsalkfjlkdsajf","nonceStr":"fdslkjflkdsjflksjf","key":"fjsdalkfjlsaj","signType":"RSA","signStr":"wrwrw","md5Str":"","bizCnt":{"outBatchNo":"N20201125121211009","startDate":"","endDate":"","outset":"0","offset":"2","rstSts":"","txType":""}}
        },
        {
        ...
        {
            "title":"009-起始笔数等于超过数据库现存数，查询无结果",
            "expection":"",
        ...
        {
            "title":"012-outBatchNo存在非当前渠道，查询无结果",
            "expection":"",
            "case":{"channel":channel,"method":"elm.pmt.trade.query.batch","charset":"UTF-8","reqDateTime":time.strftime("%Y-%m-%d %H:%M:%S"),"version":"1.0","notifyUrl":"","authToken":"flajslkfjsalkfjlkdsajf","nonceStr":"fdslkjflkdsjflksjf","key":"fjsdalkfjlsaj","signType":"RSA","signStr":"wrwrw","md5Str":"","bizCnt":{"outBatchNo":"N20201125121211003","startDate":"","endDate":"","outset":"0","offset":"2","rstSts":"","txType":""}}
        },
        {
            "title":"012-outBatchNo超过51，查询无结果",
            "expection":"",
...
class Trade_query_batch_100_data():
    cases = [
        {
            "title":"000-查询成功",
            "expection":"2",
        ...
        },
        {
            "title":"003-查询指定outBatchNo，查询成功",
            "expection":"2",
            "case":{"channel":channel,"method":"elm.pmt.trade.query.batch","charset":"UTF-8","reqDateTime":time.strftime("%Y-%m-%d %H:%M:%S"),"version":"1.0","notifyUrl":"","authToken":"flajslkfjsalkfjlkdsajf","nonceStr":"fdslkjflkdsjflksjf","key":"fjsdalkfjlsaj","signType":"RSA","signStr":"wrwrw","md5Str":"","bizCnt":{"outBatchNo":"BN202011261451020013","startDate":"","endDate":"","outset":"0","offset":"2","rstSts":"","txType":""}}
        },
        {
            "title":"004-查询指定交易状态，查询成功",
            "expection":"2",
...
if __name__ == "__main__":
    print(Trade_query_batch_100_data.cases[9]["case"])