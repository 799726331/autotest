...
pyrCustAccNo = "12180001040011850"              # 付款方客户账号
pyrAccNm = ""                                   # 付款方账户名称,非必填
rcvPrtDepBnkNm =""                              # 收款方开户行名称,非必填
rcvPrtBnkCD = "105375271000"                    # 收款方联行号
rcvPrtCustAccNo = "6228480669224802274"           # 收款方客户账号
rcvPtAcNm = "温少冉"            # 收款方账户名称

class Transfer_abc_Data():
    """
        人民币单笔付款
    """
    cases = [
        {
            "title":"000-支付成功",
            "expection":"1",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0000","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0000","rqsAmt":"1.01","docUser":"单据制单用户","pyReCo":"付款公司名称","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"02","pyrAdr":"付款方地址","rcvCy":"中国","rcvPr":"广东省","rcvCity":"广州市","settMod":"线上支付","mkrCom":"制单公司","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"01","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"01","rcvPrtAdr":"收款方地址","urgntTpCd":"01","useNm":"用途名称","rmrk":"用途","cstMblPhNo":"13044444444","sMSCntnt":"短信内容","emailAdr":"123@qq.com","mailCntDsc":"邮件内容描述","rstNoticeUrl":"付款结果通知地址","ccyCd":"CNY"}}
        },
        {
            "title":"001-仅必填，支付成功",
            "expection":"1",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0001","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0001","rqsAmt":"0.01","docUser":"","pyReCo":"","pyrDepBnkNm":"","pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":"","pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":"","rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
        },
        {
            "title":"002-custPyNo重复",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0001","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0002","rqsAmt":"0.02","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
        },
        {
            "title":"003-custPyNo为空",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0003","rqsAmt":"0.03","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
        },
        {
            "title":"004-单位时间支付金额与账号重复",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0004","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0004","rqsAmt":"0.01","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
        },
        {
            "title":"005-付款账号不在壹链盟平台",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0005","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0005","rqsAmt":"0.05","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":"45556773827738343","pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
        },
        {
            "title":"006-账号禁用",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0006","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0006","rqsAmt":"0.06","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":"45556773827243","pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
        }, 
        {
            "title":"007-单笔支付额度限制",
            "expection":"1",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0007","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0007","rqsAmt":"99.99","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
        },
        {
            "title":"008-支付金额位数校验:整数",
            "expection":"1",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0008","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0008","rqsAmt":"8","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
        },
        {
            "title":"009-支付金额位数校验:小数点1位",
            "expection":"1",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0009","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0009","rqsAmt":"0.9","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
        },
        {
            "title":"010-支付金额位数校验:小数点3位",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0010","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0010","rqsAmt":"0.101","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}

        },
        {
            "title":"011-支付金额位数校验:中文",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0011","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0011","rqsAmt":"壹佰","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}

        },
        {
            "title":"012-支付金额位数校验:符号",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0012","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0012","rqsAmt":"￥1.12","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}

        },
        {
            "title":"013-支付金额位数校验:字母",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0013","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0013","rqsAmt":"1.oo","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}

        },
        {
            "title":"014-支付金额位数校验:负数",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0014","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0014","rqsAmt":"-0.14","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}

        },
        {
            "title":"015-付款账号名称与付款账号不一致",
            "expection":"1",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0015","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0015","rqsAmt":"0.15","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":"付款户名称","pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}

        },
        {
            "title":"016-收款账号与收款账号名称不一致",
            "expection":"1",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0016","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0016","rqsAmt":"0.16","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":"收款账号名","rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}

        },
        {
            "title":"017-pyrCustAccNo付款方客户账号为空",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0017","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0017","rqsAmt":"0.17","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":"","pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":rcvPrtBnkCD,"rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}

        },
        {
            "title":"018-rcvPrtBnkCD收款方联行号为空",
            "expection":"2",
            "case":{"channel":channel,"data":{"commonInput":{"channel":channel,"reqDate":time.strftime("%Y%m%d"),"reqTime":time.strftime("%H%M%S"),"bankCode":"105","version":"1.0","remark":"单笔支付"},"custPyNo":"abC"+time.strftime("%Y%m%d%H%M%S")+"0018","docNo":"Abc"+time.strftime("%Y%m%d%H%M%S")+"0018","rqsAmt":"0.18","docUser":"","pyReCo":"","pyrDepBnkNm":pyrDepBnkNm,"pyrDepBnkNo":"","pyrBnkCD":"","pyrBnkCgyCd":"","pyrCustAccNo":pyrCustAccNo,"pyrAccNm":pyrAccNm,"pyrAccCgyCd":"","pyrAdr":"","rcvCy":"","rcvPr":"","rcvCity":"","settMod":"","mkrCom":"","rcvPrtDepBnkNm":rcvPrtDepBnkNm,"rcvPrtDepBnkNo":"","rcvPrtBnkCD":"","rcvPrtBnkCgyCd":"","rcvPrtCustAccNo":rcvPrtCustAccNo,"rcvPtAcNm":rcvPtAcNm,"rcvPtAcCgyCd":"","rcvPrtAdr":"","urgntTpCd":"","useNm":"","rmrk":"","cstMblPhNo":"","sMSCntnt":"","emailAdr":"","mailCntDsc":"","rstNoticeUrl":"","ccyCd":"CNY"}}
