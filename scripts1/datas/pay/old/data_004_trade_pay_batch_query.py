...
class Trade_pay_batch_query_135_data():
    cases = [
        {
            "title":"000-查询成功",
            "expection":"N20201125121211009",
            "case":{"channel":channel,"charset":"UTF-8","method":"elm.pmt.trade.pay.batch.query","reqDateTime":time.strftime("%Y-%m-%d %H:%M:%S"),"version":"1.0","notifyUrl":"","authToken":"5d1ceafcbd05470ca2fe969bed2e6151","nonceStr":"b4rtOaBYPqmtfca2WWs8443M1IPKQI0K","key":"UZ9jHX56tgHWAav9","signType":"RSA","signStr":"wrwrw","md5Str":"","bizCnt":{"outBatchNo":"N20201125121211009"}}
        },
        {
            "title":"001-查询非当前渠道，查询无结果",
            "expection":"",
            "case":{"channel":channel,"charset":"UTF-8","method":"elm.pmt.trade.pay.batch.query","reqDateTime":time.strftime("%Y-%m-%d %H:%M:%S"),"version":"1.0","notifyUrl":"","authToken":"5d1ceafcbd05470ca2fe969bed2e6151","nonceStr":"b4rtOaBYPqmtfca2WWs8443M1IPKQI0K","key":"UZ9jHX56tgHWAav9","signType":"RSA","signStr":"wrwrw","md5Str":"","bizCnt":{"outBatchNo":"N20201125121211001"}}
        },
        {
...
class Trade_pay_batch_query_100_data():
    cases = [
        {
            "title":"000-查询成功",
