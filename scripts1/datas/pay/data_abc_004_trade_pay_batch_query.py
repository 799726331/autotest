...
class Trade_pay_batch_query_abc_data():
    """建行-批量支付查询用例数据"""
    cases = [
        {
            "title":"000-查询成功",
            "expection":"ELM-000000000",
            "case":{"channel":channel,"charset":"UTF-8","method":"elm.pmt.trade.pay.batch.query","reqDateTime":time.strftime("%Y-%m-%d %H:%M:%S"),"version":"1.0","notifyUrl":"","authToken":"5d1ceafcbd05470ca2fe969bed2e6151","nonceStr":"b4rtOaBYPqmtfca2WWs8443M1IPKQI0K","key":"UZ9jHX56tgHWAav9","signType":"RSA","signStr":"wrwrw","md5Str":"","bizCnt":{"outBatchNo":"ABCBN202012291505300000"}}
        },
        {
