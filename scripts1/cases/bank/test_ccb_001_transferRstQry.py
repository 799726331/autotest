...
from scripts1.datas.bank.data_ccb_001_transferRstQry import *
...
def transferRstQry_data(test_host):
    """用例集"""
    Transfer_Data = TransferRstQry_ccb_Data(test_host).get_case()
...
def test_ccb_transferRstQry(test_host,title,case,expection):
    """建行-单笔付款结果查询"""
    title = title
