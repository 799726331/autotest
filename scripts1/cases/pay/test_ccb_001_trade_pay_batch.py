...
from scripts1.datas.pay.data_ccb_001_trade_pay_batch import *
...
if __name__ == "__main__":
    import json
    from scripts1.datas.pay import pil
    ...
    for i in range(len(cases_list.cases)):
        ...
        if i == 700:
            ...
            resp = pay_req("135",api,case,"99999998")
