...
from scripts1.datas.bank.data_icbc_003_batchTransferRstQry import *
...
def batchTransferRstQry_data(test_host):
    """用例集"""
    if test_host == "icbc":
       batchTransferRstQry_Data = BatchTransferRstQry_icbc_Data()
...
def test_000_pay_ccb_BatchTransferRstQry(test_host):
    """支付结果批量查询"""
    i = 0
    test_data = batchTransferRstQry_data("icbc")
