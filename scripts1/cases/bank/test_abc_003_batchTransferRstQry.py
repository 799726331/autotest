...
from scripts1.datas.bank.data_abc_003_batchTransferRstQry import *
...
def batchTransferRstQry_data(test_host):
    """用例集"""
    if test_host == "abc":
       batchTransferRstQry_Data = BatchTransferRstQry_abc_Data()
...
def test_000_pay_ccb_BatchTransferRstQry(test_host):
    """支付结果批量查询"""
    i = 0
    test_data = batchTransferRstQry_data("abc")
